          ...
          <div className="space-y-4 md:space-y-6">
            {savedItems.map((item) => {
              const safeJob = {
                ...
                companyId: item.jobId?.companyId || {
                  name: "Company",
                  logo: "",
                },
              };
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between mt-10 py-4 border-t border-slate-200 gap-4">
                ...
                <div className="flex">
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center px-4 py-2 cursor-pointer disabled:cursor-not-allowed font-medium text-slate-600 disabled:opacity-40"
                  >
                    Previous
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => fetchSavedJobs(pagination.page + 1)}
                    className="w-full sm:w-auto flex items-center justify-center px-4 py-2 font-medium disabled:cursor-not-allowed text-slate-600 cursor-pointer disabled:opacity-40"
                  >
                    Next
                  </button>
                </div>
